...
<body>
  <main class="login_bg flex">
      <?php echo form_open('user_control/login_submit', array(
          "method" => "post",
          ...
          <div class="form-body p-1">
            ...
            <div class="form-group m-y2 issue-link flex">
              <a class="f-sm-ex" href="#">Forgot password?</a>
              <a class="f-sm-ex" href="<?php echo site_url('signup'); ?>">Don't have an account?</a>
            </div>
